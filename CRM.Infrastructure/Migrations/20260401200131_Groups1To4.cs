...
{
    /// <inheritdoc />
    public partial class Groups1To4 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceDeliverables_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTerms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceTerms_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceWaivers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceWaivers_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerDevices_DeviceModels_DeviceModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceScopeCases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceScopeCases_ServiceScopes_ServiceScopeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTermItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceTermItems_ServiceTerms_ServiceTermId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceWaiverCases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceWaiverCases_ServiceWaivers_ServiceWaiverId",
            ...
            migrationBuilder.CreateTable(
                name: "ServiceScopeCaseItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ServiceScopeCaseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceScopeCaseItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceScopeCaseItems_ServiceScopeCases_ServiceScopeCaseId",
                        column: x => x.ServiceScopeCaseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceWaiverCaseItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceWaiverCaseItems_ServiceWaiverCases_ServiceWaiverCaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerDevices_DeviceModelId",
                table: "CustomerDevices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDeliverables_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceScopeCaseItems_ServiceScopeCaseId",
                table: "ServiceScopeCaseItems",
                column: "ServiceScopeCaseId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceScopeCases_ServiceScopeId",
                table: "ServiceScopeCases",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTermItems_ServiceTermId",
                table: "ServiceTermItems",
                column: "ServiceTermId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTerms_ServiceId",
                table: "ServiceTerms",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceWaiverCaseItems_ServiceWaiverCaseId",
                table: "ServiceWaiverCaseItems",
                column: "ServiceWaiverCaseId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceWaiverCases_ServiceWaiverId",
                table: "ServiceWaiverCases",
                column: "ServiceWaiverId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceWaivers_ServiceId",
                table: "ServiceWaivers",
                column: "ServiceId");
